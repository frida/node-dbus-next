import ProxyObject from './client/proxy-object.js';
import constants from './constants.js';
import { DBusError } from './errors.js';
import { Message } from './message-type.js';
import handleMethod from './service/handlers.js';
    ...
    return new Promise((resolve, reject) => {
      ...
      if (msg.flags & NO_REPLY_EXPECTED) {
        ...
        const onConnectionError = (err) => {
          delete this._methodReturnHandlers[msg.serial];
          reject(err);
        };
