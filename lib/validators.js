 ...
 */
export function isBusNameValid (name) {
 ...
 */
export function assertBusNameValid (name) {
 ...
 */
export function isObjectPathValid (path) {
 ...
 * @returns {boolean} - Whether the string is a valid object path.
 */
export function assertObjectPathValid (path) {
 ...
 */
export function isInterfaceNameValid (name) {
 ...
 * @returns {boolean} - Whether the string is a valid interface name.
 */
export function assertInterfaceNameValid (name) {
 ...
 */
export function isMemberNameValid (name) {
  return !!(typeof name === 'string' &&
    name &&
    name.length > 0 &&
    name.length <= 255 &&
 ...
 * @param {string} name - The string to validate as a member name.
 */
export function assertMemberNameValid (name) {
